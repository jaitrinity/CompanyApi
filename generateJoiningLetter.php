...
$joinDate = "4th July 2022";
$fullName = "Mr. Kumar Saurav";
$address = "House No: 369, Shakti Khand -3,Ghaziabad";
$name = "Saurav";
...
$pdf->WriteHTML('<b>'.$joinDate.'<br>'.$fullName.'<br>'.$address.'</b>.');
$pdf->Ln(15);
