...
$startStopSql = "SELECT a.Event, date(a.MobileDateTime) as AttDate FROM Activity a join EmployeeMaster e on a.EmpId = e.EmpId and e.IsActive = 1 where a.EmpId = '$empId' and a.Event in ('Start','Stop') ORDER by a.ActivityId DESC LIMIT 0,1";
...
$sql = "SELECT e.*,r.RoleName as EmpRole,e1.Name as RMName
